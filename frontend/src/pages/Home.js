...
import { userAvatar, userDescription, userUsername } from '../CurrentUser';
                    ...
                    <MDBNavbarNav className='d-flex flex-row w-100'>
                        ...
                        <div className='ms-auto d-flex align-items-center'>
                            <MDBNavbarItem className='me-3 me-lg-0 d-flex align-items-end'>
                                <MDBNavbarLink onClick={() => navigate('/account', { state: { name: userUsername, description: userDescription, image: burritoImage } })} style={{ display: 'flex', flexDirection: 'row' }}>
                                    <p style={{ margin: 0, paddingRight: 5, fontWeight: 'bold' }}>Account </p>
                                </MDBNavbarLink>
                            </MDBNavbarItem>
