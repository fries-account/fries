...
const ReviewCard = ({ reviewId, avatarSrc, username, rating, comment, likes, dislikes, desc, reply }) => {
      ...
      <MDBCardBody style={{ padding: 15 }}>
        <div className="d-flex align-items-center">
          <div className="d-flex flex-row align-items-center me-3" style={{ borderRadius: 5, paddingLeft: 10 }}>
            <MDBCardImage 
              onClick={() => { navigate('/view-account', { state: { name: username, description: desc, image: avatarSrc } }) }}
              src={avatarSrc}
              alt="avatar"
              width="50"
              height="50"
